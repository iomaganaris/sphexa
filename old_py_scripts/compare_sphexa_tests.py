...
# The script assumes that there are two clones of the repository in the same parent directory:
...
MIXD_ROOT = REPO_ROOT # should be "sphexa"
DEV_ROOT  = os.path.dirname(REPO_ROOT) / (REPO_NAME + "-develop")
