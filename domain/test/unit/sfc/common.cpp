...
void spanSfcRange()
{
    ...
    EXPECT_EQ(
        spanSfcRange(I(040000), I(050000), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}),
        1);
    EXPECT_EQ(
        spanSfcRange(I(040000), I(060000), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}),
        2);
