...
void spanSfcRange()
{
    using I = KeyType;
    {
        ...
        EXPECT_EQ(spanSfcRange(I(0), I(07777), probe.data(), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 28);
    ...
    }
    {
        ...
        EXPECT_EQ(spanSfcRange(I(1), I(0742), probe.data(), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 26);
        EXPECT_EQ(reference, probe);
    }
    {
        ...
        EXPECT_EQ(spanSfcRange(I(041305), I(046000), probe.data(), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 18);
        EXPECT_EQ(reference, probe);
    }

    EXPECT_EQ(spanSfcRange(I(040000), I(050000), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 1);
    EXPECT_EQ(spanSfcRange(I(040000), I(060000), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 2);

    {
        ...
        EXPECT_EQ(spanSfcRange(pad(I(01), 3), nodeRange<I>(0), probe.data(), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}), 7);
        EXPECT_EQ(reference, probe);
    }

    EXPECT_EQ(0, spanSfcRange(I(0), I(0), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}));
    EXPECT_EQ(0, spanSfcRange(I(1), I(1), maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}, maxTreeLevel<KeyType>{}));
}
